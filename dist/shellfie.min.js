...
$(function() {
  ...
  var canvas = document.getElementById('imageBuffer');
  ...
  imageObj.onload = function() {
    ...
    //convertImage(imageData, canvas.width, canvas.height);
  };
  imageObj.src = 'test/darth-vader.jpg';

});

var convertImage = function(imageData, width, height) {
  $('pre').text( ascii.toAscii(imageData) );
};
...
function previewfile(file) {
  if (tests.filereader === true && acceptedTypes[file.type] === true) {
    var reader = new FileReader();
      ...
      var canvas = document.getElementById('uploadBuffer');
      var context = canvas.getContext('2d');
...
},{"./ascii.js":1,"jquery":3}],3:[function(require,module,exports){
/*!
